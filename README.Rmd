...
<!-- badges: start -->
[![Build Status](https://travis-ci.org/LegalLab/delimtools.svg?branch=master)](https://app.travis-ci.com/LegalLab/delimtools)
...
## Dependencies
Delimtools maily depends on the [tidyverse](https://www.tidyverse.org/) and 
