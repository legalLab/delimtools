...
void dp_get_stats(rtree_t * tree, long method,
                  double * best_logl_out, double * pvalue_out,
                  int * lrt_pass_out, unsigned int * n_species_out);
...
/* rmptp: lex fatal error handler — called via YY_FATAL_ERROR macro */
