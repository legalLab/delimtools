...
Optionally, you can install it directly from [repos](https://github.com/legalLab/delimtools/tree/main/repos) using `devtools` or by downloading the tarball and installing it manually:

```{r, eval= FALSE}
devtools::install_url("https://github.com/legalLab/delimtools/raw/refs/heads/main/repos/splits_1.0-20.tar.gz",
                      dependencies = TRUE)
```
